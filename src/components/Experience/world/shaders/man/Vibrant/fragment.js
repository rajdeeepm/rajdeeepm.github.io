...
const fragment = /* glsl */ `
  ...
  void main() {
    ...
    // Interpolate between blue and maize based on scroll
    vec3 baseColor = mix(colorStart, colorEnd, scrollProgress);
    vec3 darkBaseColor = baseColor * 0.4;

    // gl_FragColor = vec4(vNormal, 1.0);
    // gl_FragColor = vec4(fresnel);
    // gl_FragColor = txt;
    gl_FragColor = vec4(mix(darkBaseColor, txt.rgb * baseColor, fresnel), 1.0);
  }
`
