            ...
            <Heading className={emailClasses}>
              <div>
                <div className={style.emailContainer}>
                  <a className={style.email} href="mailto:rajdeepm@umich.edu">
                    rajdeepm@umich.edu
                  </a>
                </div>
              </div>
          ...
          <ContentBlock>
            <div>
              <ul className={style.list}>
                <li>
                  <a
                    href="https://linkedin.com/in/rajdeep-mukherjee-cs752004"
                    onMouseEnter={overHandler}
                    onMouseLeave={outHandler}
                    target="_blank"
                  >
                ...
                <li>
                  <a
                    href="https://scholar.google.com/citations?user=q5MaIsUAAAAJ"
                    onMouseEnter={overHandler}
                    onMouseLeave={outHandler}
                    target="_blank"
                  >
